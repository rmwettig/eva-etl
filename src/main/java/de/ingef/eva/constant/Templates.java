...
public final class Templates {
	...
	public final class Decoding {
		...
		public static final String PID_DECODE_QUERY = "select h2ik, egk_nr, kv_nummer, pid from acc_adb.AVK_ADB_PID_AKTUELL where h2ik = '%s' order by pid, egk_nr, kv_nummer desc";
	}
}
